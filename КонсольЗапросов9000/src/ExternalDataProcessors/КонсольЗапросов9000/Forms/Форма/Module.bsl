...
Процедура Команда_РезультатВТабличныйДокумент(Команда)
	...
	ПараметрыОткрытия = Новый Структура("Объект, АдресРезультатаЗапроса, РезультатВПакете, ИмяЗапроса, ВидРезультата", Объект, АдресРезультатаЗапроса, РезультатВПакете, Параметры.ИмяЗапросаРезультата, ВидРезультата);
...
Процедура Команда_РезультатВПараметр(Команда)
	...
	ПараметрыОткрытия = Новый Структура("Объект, ТипЗначения, ТипКонтейнера, Имя, ВЗапросРазрешено, ВПараметр", Объект, тзТаблица, 3, Параметры.ИмяЗапросаРезультата, Ложь, Истина);
