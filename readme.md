Продвинутый инструмент запроса (Консоль запросов 9000) версии 1.0.0.1
...
Исправления:
- Исправлена ошибка получения имени предопределенных значений Справочников и Перечислений.
- Исправлена ошибка при выборе группы.


Моды:
- Добавлена возможность скрывать пакет запросов. Т.к. Не на всех расширениях удобно ее видеть. 
- Интерфейс стал компактным.
- Добавлена возможность просмтора типов полей в запросе (Дерево запроса). 
